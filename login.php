        ...
        <div class="row justify-content-center">
            ...
            if (isset($_GET['pesan'])) {
                if ($_GET['pesan'] == 'gagal') {
                    ...
                    echo "<div class='alert alert-success'>Anda telah berhasil membuat akun, silahkan login</div>";
                }
            }
            ?>   
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <p>Belum Punya Akun? <a class="small" href="registrasi.php">Buat Akun</a></p>
                                        <br>
