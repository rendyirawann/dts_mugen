    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            ?>   
                                    ...
                                    <form class="user" action="simpan_registrasi.php" method="POST">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user"
                                                id="nama_lengkap" name="nama_lengkap" aria-describedby="emailHelp"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="password" class="form-control form-control-user"
                                                id="verifypassword" name="verifypassword" aria-describedby="emailHelp"
                                    ...
                                    <div class="text-center">
                                        <p>Sudah Punya Akun? <a class="small" href="login.php">Login Disini</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
